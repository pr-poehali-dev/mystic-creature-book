...
const creatures: Creature[] = [
  {
    ...
    origin: 'Болота и дремучіе лѣса Новгородской земли. Говорятъ, что порожденъ онъ проклятіемъ древнихъ волхвовъ, наложеннымъ на невиннаго ежа за то, что тотъ не уступилъ дорогу колдуну.',
