...
const creatures: Creature[] = [
  {
    ...
    habitat: 'Болота и дремучіе лѣса близъ Новгорода'
  },
  {
    ...
    habitat: 'Заброшенныя деревни и мѣста казней'
  },
  {
    id: 'nochnaya-baba',
    name: 'Ночная Баба',
    ...
    habitat: 'Заброшенные погосты и старыя церкви'
  },
  {
    id: 'krovopijca',
    ...
    habitat: 'Степи и пограничныя земли'
  },
  {
    id: 'krasnoglazaya-nechist',
    name: 'Красноглазая Нечисть',
    century: '12',
    centuryRoman: 'XII',
    description: 'Тварь безобразная и мерзкая, что скрывается въ тѣни. Тѣло её покрыто чешуёй цвѣта запёкшейся крови, а изъ спины торчатъ костяныя наросты. Но страшнѣе всего — глаза. Два огромныхъ алыхъ ока, горящихъ въ темнотѣ, какъ угли въ преисподней. Взглядъ её парализуетъ волю.',
    origin: 'Явилась въ годы великаго голода, когда люди въ отчаяніи обращались къ тёмнымъ силамъ. Нѣкто призвалъ её изъ бездны, надѣясь получить помощь, но получилъ лишь проклятіе. Съ тѣхъ поръ бродитъ она по землѣ, питаясь страхомъ и отчаяніемъ.',
    danger: 'Красноглазая Нечисть охотится на одинокихъ путниковъ въ ночи. Её красные глаза гипнотизируютъ жертву, лишая способности двигаться. Затѣмъ она медленно приближается и высасываетъ жизненныя силы, оставляя лишь иссохшую оболочку. Говорятъ, что единственное спасеніе — не смотрѣть ей въ глаза и читать молитву безпрестанно.',
    habitat: 'Тёмныя пещеры и подземелья'
  },
  {
    id: 'bolotnik',
    ...
    habitat: 'Глухія болота и трясины'
  },
  {
    id: 'kostyanoj-pes',
    name: 'Костяной Псъ',
    ...
    habitat: 'Древніе курганы и склепы'
  },
  {
    id: 'ezhonok-maly',
    name: 'Ѣжонокъ Малый',
    ...
    danger: 'Ѣжонокъ Малый совершенно безобиденъ. Напротивъ, онъ любопытенъ и игривъ, какъ обычное лѣсное дитя. Фіолетовое сíяніе его иголокъ помогаетъ заблудившимся путникамъ найти дорогу изъ лѣса. Говорятъ, что онъ плачетъ по ночамъ, скучая по матери, которую никогда не видѣлъ.',
    habitat: 'Лѣсныя опушки близъ болотъ'
  }
];
          ...
          >
            ...
            <div className="space-y-6 text-foreground">
              ...
              {currentCreature.habitat && (
                <div className="bg-secondary/50 border-2 border-border/50 rounded p-6">
                  <h2 className="text-2xl font-bold text-blood mb-3 flex items-center gap-2">
                  ...
                  <div className="mt-4 rounded border-2 border-blood/30 overflow-hidden">
                    <img 
                      src="https://cdn.poehali.dev/projects/02973186-b0c4-46b2-a4c7-cd1b5835e073/files/0c2a2f68-cf2a-42c1-8f06-3148aa4c46b7.jpg"
                      alt="Карта мѣстъ обитанія"
